...
/***/ function(module, exports) {
	...
	*/
	...
	b.connection}else c.type==Blockly.PREVIOUS_STATEMENT&&(g=f.nextConnection);g?c.connect(g):console.warn("Can't connect to non-existant input: "+e)}}else console.warn("Can't move non-existant block: "+this.blockId)};Blockly.Events.DragOutside=function(a){a&&Blockly.Events.DragOutside.superClass_.constructor.call(this,a)};goog.inherits(Blockly.Events.DragOutside,Blockly.Events.Abstract);Blockly.Events.BlockDragOutside=Blockly.Events.DragOutside;Blockly.Events.DragOutside.prototype.type=Blockly.Events.DRAG_OUTSIDE;
	Blockly.Events.DragOutside.prototype.toJson=function(){var a=Blockly.Events.DragOutside.superClass_.toJson.call(this);this.isOutside&&(a.isOutside=this.isOutside);return a};Blockly.Events.DragOutside.prototype.fromJson=function(a){Blockly.Events.DragOutside.superClass_.fromJson.call(this,a);this.isOutside=a.isOutside};Blockly.Events.DragOutside.prototype.isNull=function(){return!1};
	Blockly.Events.EndDrag=function(a,b){a&&(Blockly.Events.EndDrag.superClass_.constructor.call(this,a),this.isOutside=b)&&(this.xml=Blockly.Xml.blockToDom(a,!0))};goog.inherits(Blockly.Events.EndDrag,Blockly.Events.Abstract);Blockly.Events.BlockEndDrag=Blockly.Events.EndDrag;Blockly.Events.EndDrag.prototype.type=Blockly.Events.END_DRAG;
	Blockly.Events.EndDrag.prototype.toJson=function(){var a=Blockly.Events.EndDrag.superClass_.toJson.call(this);this.isOutside&&(a.isOutside=this.isOutside);this.xml&&(a.xml=this.xml);return a};Blockly.Events.EndDrag.prototype.fromJson=function(a){Blockly.Events.EndDrag.superClass_.fromJson.call(this,a);this.isOutside=a.isOutside;this.xml=a.xml};Blockly.Events.EndDrag.prototype.isNull=function(){return!1};
	...
	Blockly.Events.VarDelete=function(a){a&&(Blockly.Events.VarDelete.superClass_.constructor.call(this,a),this.varType=a.type,this.varName=a.name)};goog.inherits(Blockly.Events.VarDelete,Blockly.Events.Abstract);Blockly.Events.VarDelete.prototype.type=Blockly.Events.VAR_DELETE;Blockly.Events.VarDelete.prototype.toJson=function(){var a=Blockly.Events.VarDelete.superClass_.toJson.call(this);a.varType=this.varType;a.varName=this.varName;return a};
	...
	goog.inherits(Blockly.Events.VarRename,Blockly.Events.Abstract);Blockly.Events.VarRename.prototype.type=Blockly.Events.VAR_RENAME;Blockly.Events.VarRename.prototype.toJson=function(){var a=Blockly.Events.VarRename.superClass_.toJson.call(this);a.oldName=this.oldName;a.newName=this.newName;return a};Blockly.Events.VarRename.prototype.fromJson=function(a){Blockly.Events.VarRename.superClass_.fromJson.call(this,a);this.oldName=a.oldName;this.newName=a.newName};
	...
	this.workspace_.toolbox_.addDeleteStyle()};Blockly.BlockDragger.prototype.dragBlock=function(a,b){var c=this.pixelsToWorkspaceUnits_(b),d=goog.math.Coordinate.sum(this.startXY_,c);this.draggingBlock_.moveDuringDrag(d);this.dragIcons_(c);this.deleteArea_=this.workspace_.isDeleteArea(a);d=!this.workspace_.isInsideBlocksArea(a);this.draggedConnectionManager_.update(c,this.deleteArea_,d);d!==this.wasOutside_&&(this.fireDragOutsideEvent_(d),this.wasOutside_=d);this.updateCursorDuringBlockDrag_(d);return d};
	Blockly.BlockDragger.prototype.endBlockDrag=function(a,b){this.dragBlock(a,b);this.dragIconData_=[];var c=this.wasOutside_;this.fireEndDragEvent_(c);this.draggingBlock_.setMouseThroughStyle(!1);Blockly.BlockSvg.disconnectUiStop_();var d=this.pixelsToWorkspaceUnits_(b),e=goog.math.Coordinate.sum(this.startXY_,d);this.draggingBlock_.moveOffDragSurface_(e);e=this.wouldDeleteBlock_&&this.draggingBlock_.type==Blockly.PROCEDURES_DEFINITION_BLOCK_TYPE;this.maybeDeleteBlock_()||(this.draggingBlock_.moveConnections_(d.x,
	d.y),this.draggingBlock_.setDragging(!1),this.draggedConnectionManager_.applyConnections(),this.draggingBlock_.render(),this.fireMoveEvent_(),this.draggingBlock_.scheduleSnapAndBump());this.workspace_.setResizesEnabled(!0);this.workspace_.toolbox_&&this.workspace_.toolbox_.removeDeleteStyle();Blockly.Events.setGroup(!1);if(c){var f=this.workspace_;setTimeout(function(){f.undo()})}e&&(f=this.workspace_,setTimeout(function(){for(var a=f.getAllBlocks(),b=0;b<a.length;b++){var c=a[b];if(c.type==Blockly.PROCEDURES_CALL_BLOCK_TYPE&&
	(c=c.getProcCode(),!Blockly.Procedures.getDefineBlock(c,f))){alert("To delete a block definition, first remove all uses of the block");f.undo();return}}f.refreshToolboxSelection_()}))};Blockly.BlockDragger.prototype.fireDragOutsideEvent_=function(a){var b=new Blockly.Events.BlockDragOutside(this.draggingBlock_);b.isOutside=a;Blockly.Events.fire(b)};Blockly.BlockDragger.prototype.fireEndDragEvent_=function(a){a=new Blockly.Events.BlockEndDrag(this.draggingBlock_,a);Blockly.Events.fire(a)};
	...
	Blockly.Gesture.prototype.handleMove=function(a){this.updateFromEvent_(a);this.isDraggingWorkspace_?(this.workspaceDragger_.drag(this.currentDragDeltaXY_),a.preventDefault(),a.stopPropagation()):this.isDraggingBlock_&&!this.blockDragger_.dragBlock(this.mostRecentEvent_,this.currentDragDeltaXY_)&&(a.preventDefault(),a.stopPropagation())};
